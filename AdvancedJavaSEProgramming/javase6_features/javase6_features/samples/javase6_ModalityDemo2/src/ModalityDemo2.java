...
public class ModalityDemo2 {
    ...
    public static void main(String[] args) {
        ...
        // Create an initially invisible, Modeless Dialog with 
        ...
        // Create a new dialog with Dialog.ModalityType.DOCUMENT_MODAL
        ...
        // This is called "modal exclusion".
        ...
        // Since FileDialog is a modal dialog, when the application calls
        // its <code>show</code> method to display the dialog,
        // it blocks the rest of the application until the user has
        // chosen a file.
        // FileDialog gets created with Dialog(Dialog owner, String title, boolean modal)
