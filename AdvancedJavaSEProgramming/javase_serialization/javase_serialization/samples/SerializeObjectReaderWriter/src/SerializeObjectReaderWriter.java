...
public class SerializeObjectReaderWriter {
    String filePath;
    
    public static void main( String args[] ) {
        SerializeObjectReaderWriter orw = new SerializeObjectReaderWriter();
    }
    ...
    SerializeObjectReaderWriter() {
        try {
            ...
            MyExternalObject externObject = new MyExternalObject();
